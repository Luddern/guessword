...
function startNewGame() {
    ...
    //Choose random word from db and set up game
...
function handleInput(e) {
    // Ignore none-letters input and letters that have already guessed
    ...
    //Update remain guess and check fro win lose conditions
    guessLeft.innerText = maxGuesses;
